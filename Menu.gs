 ...
 * Version: 1.3 Final (Unified System)
 * รวบรวมฟังก์ชันจากทุก Service (Master, SCG, AutoPilot) ไว้ในที่เดียว
 */
...
function onOpen() {
  ...
  ui.createMenu('🚛 1. ระบบจัดการ Master Data')
      ...
      .addSeparator()
      .addItem('✅ 6️⃣ จบงาน (Finalize & Move to Mapping)', 'finalizeAndClean_MoveToMapping')
      .addSeparator()
      .addSubMenu(ui.createMenu('🛠️ Admin Tools (เครื่องมือแอดมิน)')
          .addItem('🔑 สร้าง UUID ให้ครบทุกแถว (Database)', 'assignMissingUUIDs')
          .addItem('🚑 ซ่อมแซม NameMapping (เติม ID + ลบซ้ำ)', 'repairNameMapping_Full')
      )
      .addToUi();

  // =================================================================
  // 📦 เมนูชุดที่ 2: เมนูพิเศษ SCG (Daily Operation)
  // อ้างอิงไฟล์: Service_SCG.gs
  // =================================================================
  ...
  // อ้างอิงไฟล์: Service_AutoPilot.gs
  // =================================================================
  ui.createMenu('🤖 3. ระบบอัตโนมัติ (Auto-Pilot)')
    .addItem('▶️ เปิดระบบช่วยเหลืองาน (รันทุก 10 นาที)', 'START_AUTO_PILOT')
